...
use TaskListBundle\Entity\TaskList;
use TaskListBundle\Form\TaskListType;
...
class TaskListController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TaskListBundle:TaskList')->findAll();
     ...
     * @Method("POST")
     * @Template("TaskListBundle:TaskList:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TaskListBundle:TaskList')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("TaskListBundle:TaskList:edit.html.twig")
     */
